...
// Inicialização do cliente Supabase para Next.js
...
// Durante o build, se não houver variáveis, cria um cliente mock para evitar erros
let supabase: SupabaseClient;

if (supabaseUrl && supabaseAnonKey) {
  supabase = createClient(supabaseUrl, supabaseAnonKey);
} else {
  // Cliente mock para permitir build sem variáveis (não funcionará em runtime)
  console.warn('⚠️ Variáveis de ambiente do Supabase não configuradas. Crie um arquivo .env.local com NEXT_PUBLIC_SUPABASE_URL e NEXT_PUBLIC_SUPABASE_ANON_KEY');
